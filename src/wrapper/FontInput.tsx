...
function FontInput({ prop }: { prop: string }) {
    ...
    const [value, setValue] = useState(getComponentProp(selected, prop) || "Arial");
    ...
    return (
        <div style={{ position: "relative" }}>
            <input list="fonts" className="text-input" value={value} onChange={onChange} type="text" name={prop} />
            <datalist id="fonts">
                <option value="Arial" />
