import { createBlock, deleteChar, deleteSelection, insertChar, insertSelection } from "./scene/text";
import useEditorStore from "./stores/editor";
import useVisualScene from "./stores/visual";
import type { VisualBlock, VisualSelection } from "./text/types";
import { getVisualPosition, goToLineEnd, goToLineStart, moveCursorLine, moveCursorVisual, normalizeSelectionVisual, syncModelSelection, syncVisualCursor } from "./text/util";
...
function handleTextMode(e: KeyboardEvent) {
    ...
    if (e.key.startsWith("Arrow") || ["Home", "End"].includes(e.key)) { // nav key
